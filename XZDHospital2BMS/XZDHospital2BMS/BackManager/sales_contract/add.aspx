...
<body>
          ...
          <div class="panel-body">
            ...
            <form runat="server" class="form-horizontal" role="form">
              ...
              <div class="form-group">
                <label for="tbUsername" class="col-sm-2 control-label">销售公司：</label>
                <div class="col-sm-5">
              ...
              <div class="form-group">
                <label for="tbUsername" class="col-sm-2 control-label">销售公司：</label>
                <div class="col-sm-5">
                  <input type='text' class="datepicker-here" data-language='zh' data-position="right top" />
                </div>
              </div>
              <div class="form-group">
  ...
  <script src="/static/js/i18n/datepicker.zh.js"></script>
  </head>
</body>
</html>
